...
function cut () {
  ...
  self.setBoundStyle = function (ref) {
    if ( ref === void 0 ) ref = {};
    var mask = ref.mask; if ( mask === void 0 ) mask = 'rgba(0, 0, 0, 0.56)';
    ...
    var y1 = (boundHeight - height) / 2 - lineWidth;
    var x1 = (boundWidth - width) / 2 - lineWidth;

    var y2 = boundHeight - (boundHeight - height) / 2 + lineWidth;
    var x2 = boundWidth - (boundWidth - width) / 2 + lineWidth;
